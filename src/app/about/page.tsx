      ...
      <SectionWrapper id="company-intro" className="bg-gradient-to-b from-background via-blue-50 to-teal-50 !py-24 md:!py-32">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed text-left break-words">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="p-8 border border-border rounded-xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-muted-foreground leading-relaxed break-words">
              Menjadi perusahaan terdepan dalam penyediaan barang dan jasa yang profesional, terpercaya, dan mampu beradaptasi dengan kebutuhan zaman.
            </p>
          </div>
          <div className="p-8 border border-border rounded-xl shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex items-center gap-3 mb-4">
